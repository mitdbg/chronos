"""Chronos-Code configuration — model, retry policy, runtime settings."""
...
@dataclass
class Config:
    """Runtime configuration for Chronos-Code."""
    ...
    # Paths
    memory_dir: str = ".chronos-code/memory"
    sessions_dir: str = ".chronos-code/sessions"
    ...
    external_worker_mcp_server_name: str = "chronos"
    external_worker_mcp_command: str = "chronos-code-mcp"
