"""Chronos SQLite tool — transactional MVCC database operations.
...
class ChronosSQLiteInput(BaseModel):
    """Input schema for the Chronos SQLite tool."""
...
class ChronosSQLite(BaseTool):
    ...
    Example::
        ...
        sqlite = ChronosSQLite(shim=my_shim, txn=my_txn)
        sqlite.invoke({
    ...
    args_schema: type[BaseModel] = ChronosSQLiteInput
