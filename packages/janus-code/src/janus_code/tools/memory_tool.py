...
class MemoryTool:
    """Agent auto-memory scoped to ``.janus-code/memory/``.
    ...
    running inside a Janus transaction).
    """

    name: str = "memory"
    description: str = (
        "Read/write agent auto-memory files in .janus-code/memory/. "
