"""Janus Bash tool — execute shell commands in the transactional overlay.
...
class JanusBashInput(BaseModel):
    """Input schema for the Janus bash tool."""
...
class JanusBash(BaseTool):
    ...
    Example::
        ...
        bash = JanusBash(working_dir=Path("/tmp/tar_overlayfs/.../merged"))
    ...
    args_schema: type[BaseModel] = JanusBashInput
