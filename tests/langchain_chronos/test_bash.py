"""Tests for ChronosBash — transactional bash execution on OverlayFS.
...
class TestBasicExecution:
    ...
    def test_echo(self, working_dir: Path) -> None:
        ...
        bash = ChronosBash(working_dir=working_dir)
...
class TestIsolation:
    ...
    def test_env_vars(self, working_dir: Path) -> None:
        ...
        bash = ChronosBash(working_dir=working_dir, env_vars={"MY_VAR": "test123"})
