"""Multi-data-system consistency tests for Chronos.
...
class TestMixedSystemDisabling:
    ...
    def test_sqlite_disabled_fs_works(self, fresh_dir: Path) -> None:
        ...
        ctx = ChronosContext(fresh_dir, enable_sqlite=False)
        ctx.begin()
        ctx.file_editor.invoke({
            "command": "create",
            "path": "fs_only.txt",
...
class TestTransactionControlConsistency:
    """ChronosTransactionControl mirrors system state correctly."""
