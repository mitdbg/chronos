...
def fresh_base() -> Generator[Path, None, None]:
    _require_root()
    d = Path(tempfile.mkdtemp(prefix="janus_sqlite_test_"))
...
def ctx(fresh_base: Path) -> Generator[JanusContext, None, None]:
    """JanusContext with sqlite enabled (in-memory DB)."""
    c = JanusContext(fresh_base, enable_sqlite=True)
    c.begin()
    yield c
    if c.is_active:
        c.abort()
...
@pytest.fixture
def sqlite(ctx: JanusContext) -> JanusSQLite:
    return ctx.sqlite
...
class TestRegisterTable:
    def test_register_table(self, sqlite: JanusSQLite) -> None:
    ...
    def test_register_table_with_pk(self, sqlite: JanusSQLite) -> None:
        result = sqlite.invoke({
            "command": "register_table",
            "table": "items",
    ...
    def test_register_table_with_seed(self, sqlite: JanusSQLite) -> None:
        result = sqlite.invoke({
            "command": "register_table",
            "table": "config",
    ...
    def test_register_missing_table(self, sqlite: JanusSQLite) -> None:
        result = sqlite.invoke({"command": "register_table", "columns": ["id TEXT"]})
        assert "error" in result.lower()

    def test_register_missing_columns(self, sqlite: JanusSQLite) -> None:
...
class TestPutGet:
    def _setup_table(self, sqlite: JanusSQLite) -> None:
        sqlite.invoke({
            "command": "register_table",
            "table": "users",
            "columns": ["id TEXT", "name TEXT", "email TEXT"],
    ...
    def test_put_and_get(self, sqlite: JanusSQLite) -> None:
    ...
    def test_put_update(self, sqlite: JanusSQLite) -> None:
    ...
    def test_get_nonexistent(self, sqlite: JanusSQLite) -> None:
        self._setup_table(sqlite)
        result = sqlite.invoke({"command": "get", "table": "users", "pk_value": "99"})
        assert "No row found" in result

    def test_put_missing_table(self, sqlite: JanusSQLite) -> None:
        result = sqlite.invoke({
            "command": "put",
            "row": {"id": "1", "name": "Alice"},
        })
    ...
    def test_put_missing_row(self, sqlite: JanusSQLite) -> None:
        self._setup_table(sqlite)
        result = sqlite.invoke({"command": "put", "table": "users"})
        assert "error" in result.lower()

    def test_get_missing_pk(self, sqlite: JanusSQLite) -> None:
        self._setup_table(sqlite)
...
class TestQuery:
    def _setup(self, sqlite: JanusSQLite) -> None:
        sqlite.invoke({
            "command": "register_table",
            "table": "products",
    ...
    def test_query_all(self, sqlite: JanusSQLite) -> None:
        self._setup(sqlite)
        result = sqlite.invoke({"command": "query", "table": "products"})
        assert "Widget" in result
        assert "Book" in result

    def test_query_with_filter(self, sqlite: JanusSQLite) -> None:
        self._setup(sqlite)
        result = sqlite.invoke({
            "command": "query",
            "table": "products",
    ...
    def test_query_with_limit(self, sqlite: JanusSQLite) -> None:
        self._setup(sqlite)
        result = sqlite.invoke({
            "command": "query",
            "table": "products",
    ...
    def test_query_empty(self, sqlite: JanusSQLite) -> None:
        self._setup(sqlite)
        result = sqlite.invoke({
            "command": "query",
            "table": "products",
    ...
    def test_query_missing_table(self, sqlite: JanusSQLite) -> None:
...
class TestDelete:
    ...
    def test_delete_existing(self, sqlite: JanusSQLite) -> None:
        self._setup(sqlite)
    ...
    def test_delete_nonexistent(self, sqlite: JanusSQLite) -> None:
        self._setup(sqlite)
        result = sqlite.invoke({"command": "delete", "table": "items", "pk_value": "99"})
        assert "No row found to delete" in result

    def test_delete_missing_pk(self, sqlite: JanusSQLite) -> None:
        self._setup(sqlite)
...
class TestListTables:
    def test_list_empty(self, sqlite: JanusSQLite) -> None:
        result = sqlite.invoke({"command": "list_tables"})
        assert "No tables" in result

    def test_list_after_register(self, sqlite: JanusSQLite) -> None:
        sqlite.invoke({
            "command": "register_table",
            "table": "alpha",
...
class TestSQL:
    def test_raw_select(self, sqlite: JanusSQLite) -> None:
        sqlite.invoke({
            "command": "register_table",
            "table": "t",
    ...
    def test_sql_missing(self, sqlite: JanusSQLite) -> None:
...
class TestUnknownCommand:
    def test_unknown(self, sqlite: JanusSQLite) -> None:
...
class TestSQLiteIsolation:
    ...
    def test_abort_discards_writes(self, fresh_base: Path) -> None:
        ...
        ctx = JanusContext(fresh_base, enable_sqlite=True)
        ctx.begin()
        ctx.sqlite.invoke({
            "command": "register_table",
            "table": "t",
    ...
    def test_seed_data_visible(self, sqlite: JanusSQLite) -> None:
    ...
    def test_changes_tracked(self, ctx: JanusContext) -> None:
